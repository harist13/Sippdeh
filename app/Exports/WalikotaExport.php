...
class WalikotaExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    protected $paslon;
    protected $filters;
    ...
    public function headings(): array
    {
        $title = !empty($this->filters['kabupaten_id']) ? 
            'Resume Walikota - ' . Kabupaten::find($this->filters['kabupaten_id'])->nama :
            'Resume Walikota - Semua Kabupaten';
