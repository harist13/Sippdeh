...
class RekapPilwali extends Component
{
    ...
    public function render()
    {
        ...
        return view('operator.dashboard.rekap-pilwali', compact('kabupatenData'));
    }

    private function getKabupatenData(): array
    {
        // Get summary data for the province by summing up all kabupaten
        $ringkasanData = ResumeSuaraPilwaliKabupaten::whereId(session('operator_kabupaten_id'))->first();
        ...
        return [
            'logo' => '',
            'nama' => session('operator_kabupaten_name'),
            'suara_sah' => $suaraSah,
