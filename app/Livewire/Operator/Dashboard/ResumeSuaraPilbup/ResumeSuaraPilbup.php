...
namespace App\Livewire\Operator\Dashboard\ResumeSuaraPilbup;
...
class ResumeSuaraPilbup extends Component
{
    ...
    private function getKecamatanTable()
    {
        ...
        return view('operator.dashboard.resume-suara-pilbup.livewire', compact('suara', 'paslon'));
    }
    ...
    private function getSuaraPerKecamatan()
    {
        ...
        $builder->where('resume_suara_pilbup_kecamatan.kabupaten_id', session('operator_kabupaten_id'));
