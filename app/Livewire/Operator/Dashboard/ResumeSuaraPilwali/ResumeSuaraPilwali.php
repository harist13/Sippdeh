...
namespace App\Livewire\Operator\Dashboard\ResumeSuaraPilwali;
...
class ResumeSuaraPilwali extends Component
{
    ...
    private function getKecamatanTable()
    {
        ...
        return view('operator.dashboard.resume-suara-pilwali.livewire', compact('suara', 'paslon'));
    }
    ...
    private function getSuaraPerKecamatan()
    {
        ...
        $builder->where('resume_suara_pilwali_kecamatan.kabupaten_id', session('operator_kabupaten_id'));
