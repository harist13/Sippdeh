...
use App\Models\DaftarPemilihPilbupKecamatan;
...
class InputDaftarPemilihPilbup extends Component
{
    ...
    public function render()
    {
        ...
        return view('operator.input-daftar-pemilih.pilbup.livewire', compact('kecamatan', 'paslon'));
    }

    private function getKecamatan(): LengthAwarePaginator
    {
        try {
            return DaftarPemilihPilbupKecamatan::query()
