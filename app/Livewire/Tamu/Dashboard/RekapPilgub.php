...
class RekapPilgub extends Component
{
    ...
    public function render()
    {
        ...
        return view('Tamu.dashboard.rekap-pilgub', compact('calon', 'total_suara', 'dptAbstainData', 'provinsiData'));
    }

    private function getProvinsiData(): array
    {
        // Get summary data for the province by summing up all kabupaten
        $kabupatenId = $this->getKabupatenIdOfTamu();
    ...
    private function getTotalDptAbstainData(): array 
    {
        ...
        $totalData = ResumeSuaraPilgubKabupaten::whereId($this->getKabupatenIdOfTamu())->first();
