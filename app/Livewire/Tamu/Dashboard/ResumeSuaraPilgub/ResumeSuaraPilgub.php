...
class ResumeSuaraPilgub extends Component
{
    ...
    private function getKecamatanTable()
    {
        ...
        return view('Tamu.dashboard.resume-suara-pilgub.livewire', compact('suara', 'paslon'));
    }
    ...
    private function getSuaraPerKecamatan()
    {
        ...
        $builder->where('resume_suara_pilgub_kecamatan.kabupaten_id', session('Tamu_kabupaten_id'));
