...
namespace App\Livewire\Tamu\Resume\Pilgub\PerTps;
...
class FilterResumeSuaraPilgubPerTps extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('Tamu.resume.pilgub.per-tps.filter-form', compact('kecamatan', 'kelurahan'));
    }
    ...
    public function applyFilter(): void
    {
        ...
        $event->to(ResumeSuaraPilgubPerTps::class);
    }
}