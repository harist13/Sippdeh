...
class FilterResumeSuaraPilgubPerWilayah extends Component
{
    ...
    public function render()
    {
        ...
        return view('Tamu.resume.pilgub.per-wilayah.filter-form', compact('kecamatan', 'kelurahan'));
    }
    ...
    private function getKecamatanOptions()
    {
        return Kecamatan::query()
            ->whereHas('kabupaten', fn (Builder $builder) => $builder->whereId(session('Tamu_kabupaten_id')))
            ->get()
