...
return new class extends Migration
{
    ...
    {
        DB::statement("CREATE VIEW resume_suara_pilwali_kelurahan AS
            SELECT
                kelurahan.id AS id,
                kelurahan.nama AS nama,
                kelurahan.kecamatan_id as kecamatan_id,
                COALESCE(SUM(resume_suara_pilwali_tps.dpt), 0) AS dpt,
                COALESCE(SUM(resume_suara_pilwali_tps.kotak_kosong_pilwali), 0) AS kotak_kosong_pilwali,
    ...
    {
        DB::statement("DROP VIEW resume_suara_pilwali_kelurahan");
    }
};