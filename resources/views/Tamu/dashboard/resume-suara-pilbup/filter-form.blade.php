<div>
    @include('Tamu.dashboard.resume-suara-pilbup.wilayah-selects.select-kabupaten')
    @include('Tamu.dashboard.resume-suara-pilbup.wilayah-selects.select-kecamatan')
    @include('Tamu.dashboard.resume-suara-pilbup.wilayah-selects.select-kelurahan')
