<div>
    @include('Tamu.dashboard.resume-suara-pilgub.wilayah-selects.select-kabupaten')
    @include('Tamu.dashboard.resume-suara-pilgub.wilayah-selects.select-kecamatan')
    @include('Tamu.dashboard.resume-suara-pilgub.wilayah-selects.select-kelurahan')
