<div>
    @include('Tamu.dashboard.resume-suara-pilwali.wilayah-selects.select-kabupaten')
    @include('Tamu.dashboard.resume-suara-pilwali.wilayah-selects.select-kecamatan')
    @include('Tamu.dashboard.resume-suara-pilwali.wilayah-selects.select-kelurahan')
