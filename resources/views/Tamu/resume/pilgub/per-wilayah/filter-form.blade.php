<div>
    @include('Tamu.resume.pilgub.per-wilayah.wilayah-selects.select-kabupaten')
    @include('Tamu.resume.pilgub.per-wilayah.wilayah-selects.select-kecamatan')
    @include('Tamu.resume.pilgub.per-wilayah.wilayah-selects.select-kelurahan')
