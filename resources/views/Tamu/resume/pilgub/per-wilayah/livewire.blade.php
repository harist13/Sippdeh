        ...
        <div class="bg-white p-4 rounded-t-[20px]">
            <div class="container mx-auto">
                <div class="flex flex-col gap-5 lg:flex-row lg:space-x-2 lg:items-center lg:justify-between">
                    ...
                    {{-- Cari dan Filter --}}
                    @include('Tamu.resume.pilgub.per-wilayah.export-search-filter')
                </div>
            </div>
        </div>
                ...
                <div class="overflow-hidden border-b border-gray-200 shadow">
                    <div class="relative px-4">
                        ...
                        @if (in_array('TPS', $includedColumns))
                            @include("Tamu.resume.pilgub.per-wilayah.wilayah-tables.tps-table", compact('suara', 'paslon', 'includedColumns'))
                        @else
