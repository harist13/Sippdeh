                ...
                <tbody class="bg-gray-100">
                    @forelse ($calon as $cal)
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="px-4 py-4 border-b border-gray-200 text-sm-mobile capitalize">{{ strtolower($cal->posisi) }}</td>
                            <td class="px-4 py-4 border-b border-gray-200 text-sm-mobile capitalize">{{ strtolower($cal->posisi == 'GUBERNUR' ? $cal->provinsi->nama : $cal->kabupaten->nama) }}</td>
