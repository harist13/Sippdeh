<div>
    @include('admin.dashboard.resume-suara-pilgub.wilayah-selects.select-kabupaten')
    @include('admin.dashboard.resume-suara-pilgub.wilayah-selects.select-kecamatan')
    @include('admin.dashboard.resume-suara-pilgub.wilayah-selects.select-kelurahan')
