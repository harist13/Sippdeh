<div class="px-6">
        ...
        <div class="bg-white p-4 rounded-t-[20px]">
            <div class="container mx-auto">
                <div class="flex flex-col gap-5 lg:flex-row lg:space-x-2 lg:items-center lg:justify-between">
                    ...
                    {{-- Cari dan Filter --}}
                    @include('admin.dashboard.resume-suara-pilgub.export-search-filter')
                </div>
            </div>
        </div>
            ...
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden border-b border-gray-200 shadow">
                    <div class="relative px-4">
                        ...
                        @include("admin.dashboard.resume-suara-pilgub.wilayah-tables.kecamatan-table", compact('suara', 'paslon'))
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- Filter Pilgub Modal --}}
    {{-- @include(
        'admin.dashboard.resume-suara-pilgub.filter-modal',
        compact(
            'selectedKabupaten',
            'selectedKecamatan',
            'selectedKelurahan',
