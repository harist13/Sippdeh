...
<div class="container mx-auto mt-8">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex space-x-2">
            <button class="bg-blue-500 text-white py-2 px-4 rounded-lg">+ Tambah Kabupaten/Kota</button>
            <div class="relative">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full leading-normal text-sm">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100">
                    <td class="px-4 py-4 border-b border-gray-200 bg-white text-sm">002</td>
                    <td class="px-4 py-4 border-b border-gray-200 bg-white text-sm">Balikpapan</td>
                    <td class="px-4 py-4 border-b border-gray-200 bg-white text-sm">Kalimantan Timur</td>
                    <td class="px-4 py-4 border-b border-gray-200 bg-white text-sm">
                        <a href="#" class="text-blue-600 hover:text-blue-900"><i class="fas fa-edit"></i></a>
                        <a href="#" class="text-red-600 hover:text-red-900 ml-3"><i class="fa fa-trash"></i></a>
