...
<div class="container mx-auto mt-8">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex space-x-2">
            ...
            <button id="addKelurahanBtn" class="bg-blue-500 text-white py-2 px-4 rounded-lg">+ Tambah Kelurahan</button>
            <div class="relative">
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3">
                <button id="cancelAddKelurahan" class="px-4 py-2 bg-gray-200 text-gray-800 text-base font-medium rounded-md w-24 mr-2">
                    Batalkan
                </button>
                <button id="confirmAddKelurahan" class="px-4 py-2 bg-blue-500 text-white text-base font-medium rounded-md w-24 ml-2">
                    Tambah
                </button>
            </div>
        </div>
...
<div id="editKelurahanModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3">
                <button id="cancelEditKelurahan" class="px-4 py-2 bg-gray-200 text-gray-800 text-base font-medium rounded-md w-24 mr-2">
                    Batalkan
                </button>
                <button id="confirmEditKelurahan" class="px-4 py-2 bg-blue-500 text-white text-base font-medium rounded-md w-24 ml-2">
                    Simpan
                </button>
            </div>
        </div>
