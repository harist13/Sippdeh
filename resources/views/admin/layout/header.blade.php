...
<div id="sidebar" class="fixed top-0 left-0 z-1050 w-64 h-full overflow-y-auto bg-white shadow-lg sidebar hidden">
    ...
    <nav class="mt-4">
        ...
        <a href="{{ route('Dashboard') }}" class="sidebar-item flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-100">
        ...
        <a href="{{ route('user')}}" class="sidebar-item flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-100">
            <img src="{{ asset('assets/icon/User.png') }}" alt="" class="w-5 h-5 mr-3">
            <span>User</span>
        </a>
        <hr class="my-2 border-gray-200">
        <div class="px-4 py-2 text-gray-700 font-bold text-base">Data</div>
        <a href="{{ route('provinsi')}}" class="sidebar-item flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-100">
            <img src="{{ asset('assets/icon/Building3.png') }}" alt="" class="w-5 h-5 mr-3">
            <span>Provinsi</span>
        </a>
        <a href="{{ route('kabupaten')}}" class="sidebar-item flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-100">
            <img src="{{ asset('assets/icon/Building2.png') }}" alt="" class="w-5 h-5 mr-3">
            <span>Kabupaten/Kota</span>
        </a>
        <a href="{{ route('kecamatan')}}" class="sidebar-item flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-100">
            <img src="{{ asset('assets/icon/Building.png') }}" alt="" class="w-5 h-5 mr-3">
            <span>Kecamatan</span>
        </a>
        <a href="{{ route('kelurahan')}}" class="sidebar-item flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-100">
            <img src="{{ asset('assets/icon/Garage.png') }}" alt="" class="w-5 h-5 mr-3">
            <span>Kelurahan</span>
        </a>
        <a href="{{ route('tps')}}" class="sidebar-item flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-100">
            <img src="{{ asset('assets/icon/tps.png') }}" alt="" class="w-5 h-5 mr-3">
            <span>TPS</span>
        </a>
        <a href="{{ route('calon')}}" class="sidebar-item flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-blue-100">
            <img src="{{ asset('assets/icon/calon.png') }}" alt="" class="w-5 h-5 mr-3">
            <span>Calon Kabupaten/Kota</span>
        </a>
    </nav>
</div>
