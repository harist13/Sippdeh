                ...
                <div class="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    ...
                    <div
                        ...
                        <div class="flex items-center rounded-lg bg-[#ECEFF5] px-4 py-2">
                            ...
                            <input type="search" id="searchInput" placeholder="Cari..." name="cari"
                        ...
                        <tbody class="bg-gray-100">
                            ...
                            <tr class="border-b search-row">
                                ...
                                <td class="py-3 px-4 border-r">
                                    ...
                                    $colorClass = $partisipasi >= 80 ? 'bg-green-400' : ($partisipasi >= 60 ?
                                    'bg-yellow-400' : 'bg-red-400');
                                    @endphp
                                    <div
                                        class="participation-button {{ $colorClass }} text-white py-1 px-7 rounded text-xs">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <select id="filterKabupaten"
                                class="w-full h-10 px-3 text-sm border border-[#e0e0e0] rounded-lg focus:outline-none focus:border-[#3560a0] bg-white">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" class="hidden partisipasi-checkbox" value="hijau"
                                        {{ in_array('hijau', $selectedPartisipasi) ? 'checked' : '' }}>
                                    <span
                                        class="px-3 py-1 rounded-full border text-sm font-medium partisipasi-label {{ in_array('hijau', $selectedPartisipasi) ? 'bg-[#3560a0] text-[#69d788]' : 'text-gray-600' }}">
                                        Hijau
                                    </span>
                                </label>
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" class="hidden partisipasi-checkbox" value="kuning"
                                        {{ in_array('kuning', $selectedPartisipasi) ? 'checked' : '' }}>
                                    <span
                                        class="px-3 py-1 rounded-full border text-sm font-medium partisipasi-label {{ in_array('kuning', $selectedPartisipasi) ? 'bg-[#3560a0] text-[#ffe608]' : 'text-gray-600' }}">
                                        Kuning
                                    </span>
                                </label>
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" class="hidden partisipasi-checkbox" value="merah"
                                        {{ in_array('merah', $selectedPartisipasi) ? 'checked' : '' }}>
                                    <span
                                        class="px-3 py-1 rounded-full border text-sm font-medium partisipasi-label {{ in_array('merah', $selectedPartisipasi) ? 'bg-[#3560a0] text-[#fe756c]' : 'text-gray-600' }}">
                                        Merah
                                    </span>
                                </label>
                            </div>
