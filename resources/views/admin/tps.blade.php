...
<div class="container mx-auto mt-8">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex space-x-2">
            ...
            <button id="addTPSBtn" class="bg-blue-500 text-white py-2 px-4 rounded-lg">+ Tambah TPS</button>
            <div class="relative">
                <input type="text" placeholder="Cari" class="border border-gray-300 rounded-lg pl-10 pr-4 py-2">
        ...
        <table class="min-w-full leading-normal text-sm">
            ...
            <tbody>
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-4 border-b border-gray-200 bg-white text-sm">TPS 1</td>
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3">
                <button id="cancelAddTPS" class="px-4 py-2 bg-gray-200 text-gray-800 text-base font-medium rounded-md w-24 mr-2">
                    Batalkan
                </button>
                <button id="confirmAddTPS" class="px-4 py-2 bg-blue-500 text-white text-base font-medium rounded-md w-24 ml-2">
                    Tambah
                </button>
            </div>
        </div>
...
<div id="editTPSModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3">
                <button id="cancelEditTPS" class="px-4 py-2 bg-gray-200 text-gray-800 text-base font-medium rounded-md w-24 mr-2">
                    Batalkan
                </button>
                <button id="confirmEditTPS" class="px-4 py-2 bg-blue-500 text-white text-base font-medium rounded-md w-24 ml-2">
                    Simpan
                </button>
            </div>
        </div>
