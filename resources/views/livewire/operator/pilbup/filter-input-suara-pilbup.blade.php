<div>
    ...
    <div class="flex">
        ...
        <button type="submit" wire:loading.attr="disabled" wire:click="applyFilter" id="applyFilterPilbup" class="flex-1 bg-[#3560A0] disabled:bg-[#0070F06c] hover:bg-blue-700 text-white rounded-md px-4 py-2">
            Terapkan
        </button>
    </div>
</div>
