<div>
            ...
            @if (!empty($selectedProvinsi))
                <li class="flex items-center gap-2 w-full">
                    <label class="flex items-center gap-3" for="pilihProvinsi">
                        <input type="checkbox" id="pilihProvinsi" value="PROVINSI" wire:model="includedColumns"
            ...
            @if (!empty($selectedKabupaten))
                <li class="flex items-center gap-2 w-full">
                    <label class="flex items-center gap-3" for="pilihKabupaten">
                        <input type="checkbox" id="pilihKabupaten" value="KABUPATEN" wire:model="includedColumns"
                            class="form-checkbox h-5 w-5 text-white border-white rounded focus:ring-blue-500 focus:ring-2 checked:bg-blue-500 checked:border-blue-500 transition duration-200 cursor-pointer">
    ...
    <div class="mb-5" x-data="{ partisipasiList: $wire.partisipasi }">
        ...
        <div class="flex gap-2">
            <label for="partisipasi-hijau-pilgub" class="flex items-center gap-2 cursor-pointer">
                <input 
                    type="checkbox" 
                    class="hidden" 
                    id="partisipasi-hijau-pilgub" 
                    value="HIJAU" 
                    wire:model="partisipasi"
                    x-on:change="partisipasiList = $wire.partisipasi" 
                />
                <span 
                    class="bg-green-400 text-white py-2 px-7 rounded text-sm select-none transition-all duration-200"
                    :class="{ 
                        'border-2 border-blue-500': partisipasiList.includes('HIJAU'), 
                        'border-2 border-transparent': !partisipasiList.includes('HIJAU') 
                    }"
                >
                    > 80%
                </span>
            ...
            <label for="partisipasi-kuning-pilgub" class="flex items-center gap-2 cursor-pointer">
                <input 
                    type="checkbox" 
                    class="hidden" 
                    id="partisipasi-kuning-pilgub" 
                    value="KUNING" 
                    wire:model="partisipasi"
                    x-on:change="partisipasiList = $wire.partisipasi" 
                />
                <span 
                    class="bg-yellow-400 text-white py-2 px-7 rounded text-sm select-none transition-all duration-200"
                    :class="{ 
                        'border-2 border-blue-500': partisipasiList.includes('KUNING'), 
                        'border-2 border-transparent': !partisipasiList.includes('KUNING') 
                    }"
                >
                    > 60%
                </span>
            ...
            <label for="partisipasi-merah-pilgub" class="flex items-center gap-2 cursor-pointer">
                <input 
                    type="checkbox" 
                    class="hidden" 
                    id="partisipasi-merah-pilgub" 
                    value="MERAH" 
                    wire:model="partisipasi"
                    x-on:change="partisipasiList = $wire.partisipasi" 
                />
                <span 
                    class="bg-red-400 text-white py-2 px-7 rounded text-sm select-none transition-all duration-200"
                    :class="{ 
                        'border-2 border-blue-500': partisipasiList.includes('MERAH'), 
                        'border-2 border-transparent': !partisipasiList.includes('MERAH') 
                    }"
                >
                    < 60%
                </span>
    ...
    <div class="flex gap-4">
        <button type="button" wire:loading.attr="disabled" wire:target="selectedKabupaten, selectedKecamatan, selectedKelurahan, applyFilter, resetFilter" wire:click="resetFilter" class="flex-1 relative bg-gray-300 disabled:bg-[#d1d5d06c] hover:bg-gray-400 text-black rounded-md px-4 py-2 mr-2">
            <div class="flex items-center justify-center">
                <svg wire:loading wire:target="resetFilter" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <button type="submit" wire:loading.attr="disabled" wire:target="selectedKabupaten, selectedKecamatan, selectedKelurahan, applyFilter, resetFilter" wire:click="applyFilter" id="applyFilterPilgub" class="flex-1 relative bg-[#3560A0] disabled:bg-[#0070F06c] hover:bg-blue-700 text-white rounded-md px-4 py-2">
            <div class="flex items-center justify-center">
