                ...
                <thead class="bg-[#3560a0] text-white">
                    <tr>
                        ...
                        @if(in_array('kecamatan', $shownColumns))
                            <th class="py-1.5 px-2 border-r border-white">Kecamatan</th>
                        @endif
                        @if(in_array('kelurahan', $shownColumns))
                            <th class="py-1.5 px-2 border-r border-white">Kelurahan</th>
                        @endif
                ...
                <tbody class="bg-gray-100">
                    ...
                    <tr class="border-b">
                        <td class="py-1.5 px-2 border-r">
                            {{ str_pad(($walikotaData->currentPage() - 1) * $walikotaData->perPage() + $loop->iteration, 3, '0', STR_PAD_LEFT) }}
                        </td>
                        @if(in_array('kabupaten', $shownColumns))
                            <td class="py-1.5 px-2 border-r">{{ $data->kabupaten_nama }}</td>
                        @endif
                        @if(in_array('kecamatan', $shownColumns))
                            <td class="py-1.5 px-2 border-r">{{ $data->kecamatan_nama }}</td>
                        @endif
                        @if(in_array('kelurahan', $shownColumns))
                            <td class="py-1.5 px-2 border-r">{{ $data->kelurahan_nama }}</td>
                        @endif
