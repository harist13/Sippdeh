...
<body class="h-full overflow-hidden">
    ...
    <div class="mb-4">
        ...
        <div class="relative">
            ...
            <input name="email" class="w-full px-3 py-2 pl-10 leading-tight text-gray-700 border rounded appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500" id="email" type="email" placeholder="Masukan email yang telah terdaftar">
        </div>
    </div>
    <div class="mb-6">
