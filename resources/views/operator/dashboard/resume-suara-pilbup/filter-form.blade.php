<div>
    @include('operator.dashboard.resume-suara-pilbup.wilayah-selects.select-kabupaten')
    @include('operator.dashboard.resume-suara-pilbup.wilayah-selects.select-kecamatan')
    @include('operator.dashboard.resume-suara-pilbup.wilayah-selects.select-kelurahan')
