<div>
    @include('operator.dashboard.resume-suara-pilwali.wilayah-selects.select-kabupaten')
    @include('operator.dashboard.resume-suara-pilwali.wilayah-selects.select-kecamatan')
    @include('operator.dashboard.resume-suara-pilwali.wilayah-selects.select-kelurahan')
