<div>
        ...
        <div class="p-4">
            <div class="container mx-auto">
                ...
                <div class="flex flex-col gap-5 lg:flex-row lg:space-x-2 lg:items-center lg:justify-between">
                    ...
                    @include('operator.input-daftar-pemilih.pilwali.action-buttons')
                    
                    {{-- Cari dan Filter --}}
                    @include('operator.input-daftar-pemilih.pilwali.export-search-filter')
                </div>
                ...
                {{-- Loading --}}
                @include('operator.input-daftar-pemilih.pilwali.loading-alert')
    ...
    <div class="overflow-x-auto -mx-4 sm:mx-0">
        <div class="inline-block min-w-full align-middle">
            <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg relative">
                ...
                <div class="px-4">
                    @include('operator.input-daftar-pemilih.pilwali.table', compact('kecamatan'))
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- Filter Pilgub Modal --}}
    {{-- @include(
        'operator.input-daftar-pemilih.pilwali.filter-modal',
