<div>
    <div class="flex items-center gap-3">
        ...
        <button type="button" 
            ...
            class="flex relative bg-[#16b335] disabled:bg-[#16b3356a] hover:bg-[#308341] text-white text-sm font-medium px-4 py-2 rounded-lg sm:w-auto w-full">
            <div class="flex items-center justify-center">
                <i wire:loading.remove wire:target="downloadTemplate" class="fas fa-file-excel w-4 h-4 mr-2"></i>
                <svg wire:loading wire:target="downloadTemplate" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
