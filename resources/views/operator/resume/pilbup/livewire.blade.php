<div>
        ...
        <div class="bg-white p-4 rounded-t-[20px]">
            <div class="container mx-auto">
                <div class="flex flex-col gap-5 lg:flex-row lg:space-x-2 lg:items-center lg:justify-between">
                    ...
                    {{-- Cari dan Filter --}}
                    @include('operator.resume.pilbup.export-search-filter')
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto -mx-4 sm:mx-0">
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg relative">
                    ...
                    <div class="px-4">
                        @include("operator.resume.pilbup.wilayah-tables.$scope-table", compact('suara', 'paslon',
                        'includedColumns'))
                    </div>
                </div>
            </div>
    ...
    <div class="w-[70%] grid grid-cols-2 justify-center gap-5 mx-auto">
        @php
    ...
    <!-- Filter Pilgub Modal -->
    @include(
        'operator.resume.pilbup.filter-modal',
        compact(
            'selectedKecamatan',
            'selectedKelurahan',
            'includedColumns',
