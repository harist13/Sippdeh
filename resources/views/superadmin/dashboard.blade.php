...
@section('content')
    <main class="bg-white shadow-lg rounded-lg p-8 max-w-7xl mx-auto my-8">
        ...
        <div class="container mx-auto px-4">
                                ...
                                <div class="p-3 text-white bg-blue-900 rounded-lg">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="text-center w-1/3">
                                            <h2 class="text-xl font-bold">Tingkat Partisipasi Masyarakat Provinsi<br>{{ $provinsiData['nama'] }}</h2>
                                        </div>
                                ...
                                <div class="p-3 text-white bg-blue-900 rounded-lg">
                                    <div class="flex items-center justify-between">
                                       <div class="flex flex-col items-start w-1/3">
                                        ...
                                        <div class="text-center w-1/3">
                                            <h2 class="text-xl font-bold">Tingkat Partisipasi Masyarakat<br>{{$data['nama']}}</h2>
                                        </div>
                                        <div class="text-right w-1/3">
            ...
            @livewire('superadmin.dashboard.resume-suara-pilgub.resume-suara-pilgub')
    </main>
@endsection
