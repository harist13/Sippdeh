<div>
        ...
        <div class="bg-white p-4">
            <div class="container mx-auto">
                <div class="flex flex-col gap-5 lg:flex-row lg:space-x-2 lg:items-center lg:justify-between">
                    ...
                    {{-- Cari dan Filter --}}
                    @include('superadmin.resume.pilbup.per-wilayah.export-search-filter')
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto -mx-4 sm:mx-0">
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg relative">
                    ...
                    <div class="px-4">
                        @include("superadmin.resume.pilbup.per-wilayah.wilayah-tables.$scope-table", compact('suara', 'paslon',
                        'includedColumns'))
                    </div>
                </div>
            </div>
    ...
    <!-- Filter Pilgub Modal -->
    @include(
        'superadmin.resume.pilbup.per-wilayah.filter-modal',
        compact(
            'selectedKecamatan',
            'selectedKelurahan',
            'includedColumns',
