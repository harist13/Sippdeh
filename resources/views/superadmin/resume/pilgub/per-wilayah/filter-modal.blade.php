<div id="filterPilgubPerWilayahModal" class="bg-gray-600 bg-opacity-50 fixed inset-0 hidden z-50">
    <div class="bg-white border max-h-[80%] my-24 w-96 shadow-lg rounded-md mx-auto px-5 py-5 overflow-y-scroll">
        ...
        @livewire(
            'superadmin.resume.pilgub.per-wilayah.filter-resume-suara-pilgub-per-wilayah',
            compact(
                'selectedKabupaten',
                'selectedKecamatan',
                'selectedKelurahan',
